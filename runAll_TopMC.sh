...
root -l -b -q RunTree_ReReco.C\(\"TTJets_MadSpinPDF\",30\)
root -l -b -q RunTree_ReReco.C\(\"TTJets_matchingdown\",30\)
root -l -b -q RunTree_ReReco.C\(\"TTJets_matchingup\",30\)
root -l -b -q RunTree_ReReco.C\(\"TTJets_scaledown\",30\)
root -l -b -q RunTree_ReReco.C\(\"TTJets_scaleup\",30\)
root -l -b -q RunTree_ReReco.C\(\"TTbar_Powheg\",30\)
root -l -b -q RunTree_ReReco.C\(\"TTbar_Powheg_Herwig\",30\)
